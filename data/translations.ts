  ...
  skills: {
    ...
    items: {
      fr: [
        ...
        { name: "FAISS", category: "Data Science & IA", description: "Recherche sémantique et similarité vectorielle", icon: "search" },
        { name: "RAG / LLM", category: "Data Science & IA", description: "Sentence Transformers, assistants IA, copilot", icon: "message-square-text" },
        { name: "NLP", category: "Data Science & IA", description: "Extraction de sens et traitement du langage", icon: "search" },
        { name: "Power BI", category: "Data Science & IA", description: "KPI, dashboards managers et aide à la décision", icon: "bar-chart-3" },
      ...
      en: [
        ...
        { name: "Machine Learning", category: "Data Science & IA", description: "Anomaly detection, prediction, and evaluation", icon: "brain-circuit" },
        { name: "FAISS", category: "Data Science & IA", description: "Semantic search and vector similarity", icon: "search" },
        { name: "RAG / LLM", category: "Data Science & IA", description: "Sentence Transformers, AI assistants, copilot", icon: "message-square-text" },
        { name: "NLP", category: "Data Science & IA", description: "Meaning extraction and language processing", icon: "search" },
        { name: "Power BI", category: "Data Science & IA", description: "KPI dashboards and decision support", icon: "bar-chart-3" },
  ...
  certifications: {
    ...
    items: {
      ...
      en: [
        { title: "Building RAG Agents with LLMs", org: "NVIDIA", emoji: "🧠" },
        { title: "CCNA - Introduction to Networks", org: "Cisco", emoji: "🌐" },
        { title: "21st Century Skills Certification", org: "Honoris", emoji: "🎓" },
        { title: "Coding and Data Analytics Certification", org: "Honoris", emoji: "📈" },
        { title: "Certificate of the GO Piscine competition", org: "Centrale University", emoji: "🏆" },
      ],
    },
    languageItems: {
      fr: [
