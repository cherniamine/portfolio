...
const skillLogos: Record<string, SkillIcon> = {
  ...
  pandas: { icon: SiPandas, color: "#1d0c5f" },
  numpy: { icon: SiNumpy, color: "#4D77CF" },
  scikit: { icon: SiScikitlearn, color: "#F7931E" },
  "brain-circuit": { icon: BrainCircuit, color: "#2013cd" },
  languages: { icon: Languages, color: "#2DD4BF" },
  radar: { icon: Radar, color: "#22D3EE" },
  bot: { icon: Bot, color: "#fa8b8b" },
